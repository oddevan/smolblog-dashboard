<script lang="ts">
	import { BottomNav, BottomNavItem, Button, Modal, Tooltip } from "flowbite-svelte";

	let showNewModal = false;
</script>

<BottomNav outerDefault="md:top-52 md:left-10 md:rotate-90" position="absolute" navType="application" innerDiv="grid-cols-5">
  <BottomNavItem btnName="Reader" appBtnPosition="left" btnDefault="md:-rotate-90 md:rounded-full">
  ...
  <BottomNavItem btnName="Inbox" appBtnPosition="middle" btnDefault="md:-rotate-90">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-500" aria-hidden="true">
  ...
  <div class="flex items-center justify-center">
    <BottomNavItem on:click={() => showNewModal = true} btnName="Create new item" appBtnPosition="custom" btnDefault="inline-flex items-center justify-center w-10 h-10 font-medium bg-primary-600 rounded-full hover:bg-primary-700 group focus:ring-4 focus:ring-primary-300 focus:outline-none dark:focus:ring-primary-800 md:-rotate-90">
  ...
  <BottomNavItem btnName="Content" appBtnPosition="middle" btnDefault="md:-rotate-90">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-500" aria-hidden="true">
  ...
  <BottomNavItem btnName="Settings" appBtnPosition="right" btnDefault="md:-rotate-90 md:rounded-full">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-500" aria-hidden="true">
