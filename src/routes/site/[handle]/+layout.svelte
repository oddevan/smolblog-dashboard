<script lang="ts">
	import { BottomNav, BottomNavItem, Button, Modal, Sidebar, SidebarGroup, SidebarItem, SidebarWrapper, SpeedDial, SpeedDialButton, Tooltip } from "flowbite-svelte";
...
<div class="flex flex-row h-full space-x-3">
	<div class="w-40 hidden md:block">
		...
		<SpeedDial defaultClass="mt-3" tooltip="none" placement="bottom" textOutside>
			{@const textOutsideClass = 'block absolute left-14 top-1/2 mb-px text-sm font-medium -translate-y-1/2'}
