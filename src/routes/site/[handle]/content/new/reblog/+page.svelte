...
<ContentForm bind:meta bind:extensions onCancel={() => {}} onSave={() => {}} onPublish={() => console.log({url, comment, meta, extensions})}>
	<div class="mb-3">
	...
	<MarkdownField identifier="status" placeholder="Add to the conversation (optional)" bind:value={comment}/>
</ContentForm>