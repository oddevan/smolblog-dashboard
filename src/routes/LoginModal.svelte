<script lang="ts">
	...
	import { Basic } from '$lib/components/FormFields';
	import { field as makeField } from 'svelte-forms';
	import { makeValidators, type FormField } from '$lib/components/FormFields/BaseField.svelte';
...
<Card shadow rounded class="place-self-center min-w-fit">
	<div class="flex flex-col space-y-6">
		...
		<Basic definition={serverFieldDef} controller={serverFieldController} />
		<hr />
		...
		<div class="space-y-3">
			<Basic definition={unameFieldDef} bind:value={uname} />
			<Basic definition={passFieldDef} bind:value={pass} />
		</div>
