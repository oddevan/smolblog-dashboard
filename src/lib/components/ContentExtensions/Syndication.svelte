...
<div class="form-check form-switch syndication">
	<input
		...
		type="checkbox"
		bind:group={value.channels}
		value="54efb59e-5bb1-46bd-940e-cd764172d5c6"
		role="switch"
		id="syndicateTwitter"
	/>
...
<div class="form-check form-switch syndication">
	<input
		...
		type="checkbox"
		bind:group={value.channels}
		value="96530d6d-1a5a-43c6-a618-a1309608a23d"
		role="switch"
		id="syndicateYouTube"
	/>
...
<div class="form-check form-switch syndication">
	<input
		...
		type="checkbox"
		bind:group={value.channels}
		value="43dcdbbe-7a65-4e0e-b2c8-e53ddee3d5be"
		role="switch"
		id="syndicateMastodon"
	/>
